...
public class SignatureProvider {
    ...
    private List<ExecutableElement> methodOverloads(CompileTask task, CompilationUnitTree root, MethodInvocationTree method) {
    ...
    private List<ExecutableElement> constructorOverloads(CompileTask task, CompilationUnitTree root, NewClassTree method) {
        var trees = Trees.instance(task.task);
    ...
    private int activeParameter(CompileTask task, CompilationUnitTree root, List<? extends ExpressionTree> arguments, long cursor) {
